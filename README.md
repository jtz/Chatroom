...
Chatroom simulator is a Java application that simulates chatroom platform by using four design patterns: Factory Method, Singleton, Builder, and Observer Patterns.
